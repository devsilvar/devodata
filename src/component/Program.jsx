    ...
    <div className='bg-white py-20 px-4 sm:px-6 lg:px-8'>
      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <div className='bg-white p-8 rounded-lg shadow-lg border border-gray-200 transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl'>
            ...
            <ul className='text-teal-500 text-sm list-disc list-inside space-y-2'>
            ...
            <button className='mt-4 bg-teal-500  hover:bg-teal-600 text-white py-2 px-4 rounded-full text-sm font-semibold transition'>
              Get Started
            </button>
          </div>
          ...
          <div className='bg-white p-8 rounded-lg shadow-lg border border-gray-200 transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl'>
            ...
            <button className='mt-4 bg-teal-500 hover:bg-teal-400 text-white py-2 px-4 rounded-full text-sm font-semibold transition'>
              Join Now
            </button>
          </div>
